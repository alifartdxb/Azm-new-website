    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-8 max-w-4xl">
        ...
        {status === 'success' ? (
          ...
          >
            ...
            <p className="text-stone-600 mb-8">Successfully imported 142 products and updated 12 products.</p>
            <Link 
              to="/admin/products"
      ...
      <div className="bg-stone-50 rounded-xl p-6 border border-stone-200 max-w-4xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 text-sm text-stone-600">
          <div className="font-mono bg-white px-2 py-1 border border-stone-200 rounded">SKU*</div>
          <div className="font-mono bg-white px-2 py-1 border border-stone-200 rounded">Product Name*</div>
          ...
          <div className="font-mono bg-white px-2 py-1 border border-stone-200 rounded">Collection</div>
          <div className="font-mono bg-white px-2 py-1 border border-stone-200 rounded">Finish</div>
          <div className="font-mono bg-white px-2 py-1 border border-stone-200 rounded">Description</div>
          <div className="font-mono bg-white px-2 py-1 border border-stone-200 rounded">Image URL</div>
          <div className="font-mono bg-white px-2 py-1 border border-stone-200 rounded">PDF URL</div>
          <div className="font-mono bg-white px-2 py-1 border border-stone-200 rounded">Status</div>
        </div>
      </div>
    </div>
  );
